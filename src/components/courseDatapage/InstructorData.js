          ...
          <div className={styles.instructorCourseData}>
            ...
            <div className={styles.CourseData}>
              <span className={styles.CourseDataVal}>
                ...
                {data.allData.Rating} Instructor Rating
              </span>
              <span className={styles.CourseDataVal}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                {data.allData.reviewsNumber} Reviews
              </span>
              <span className={styles.CourseDataVal}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                {data.allData.studentsNumber} Students
              </span>
              <span className={styles.CourseDataVal}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                {data.allData.coursesNumber} Courses
              </span>
            </div>
          </div>
          <Description allData={data.allData} val={false}/>
        </div>
    </>
  );
}
