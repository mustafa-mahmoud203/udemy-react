...
function NavHeader() {
  return (
    <header>
      <nav>
        <div className={`drawer-menu ${styles.drawerMenuStyle}`}>
          <i className="fa-solid fa-bars"></i>
        </div>
        <div className={`logo ${styles.logoStyle}`}>
          <Link to={"/"}>
            <img
              className={styles.logoImgStyle}
        ...
        <div className={`nav-items ${styles.navItemsStyle}`}>
          <div className="udemy-business">
            <a className={styles.navItemsLinkStyle} href="#" target="_blank">
              Udemy Business
            </a>
          </div>
          <div className="Teach-on-udemy">
            <a className={styles.navItemsLinkStyle} href="#">
              Teach on Udemy
            </a>
          </div>
        </div>
        ...
        <div
          className={`search-shopping-icons ${styles.searchShoppingIconsStyle}`}
        >
          ...
          <div className={`shopping-icon ${styles.shoppingIconStyle}`}>
            <a href="#">
              {" "}
              <i
                className={`fa-solid fa-cart-shopping ${styles.shoppingIconStyle}`}
              ></i>
            </a>
          </div>
        </div>
        ...
        <div className={`nav-bottoms ${styles.navBottomsStyle}`}>
          <div className={`log-in ${styles.logInStyle}`}>
            <a className={styles.logInLinkStyle} href="#">
              {" "}
              Log in
            </a>
          </div>
          ...
          <div className={`sign-up ${styles.signUpStyle}`}>
            <a className={styles.signUpLinkStyle} href="#">
              Sign up
            </a>
          </div>
          <div className={`globle-icon ${styles.globleIconStyle}`}>
            <a className={styles.globleIconLinkStyle} href="#">
              {" "}
